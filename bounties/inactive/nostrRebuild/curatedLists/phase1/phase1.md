...
If you are interested in this bounty, take a look at how the Curated Lists app works on the Pretty Good Apps desktop client and tell me how you would improve the design. See these [screenshots](https://github.com/wds4/pretty-good/blob/main/appDescriptions/curatedLists/screenshots.md) or download and run the app -- I'd suggest dev mode, as I am not yet publishing releases on a routine basis. Perhaps the page is too cluttered? idk, design is not my forte!
