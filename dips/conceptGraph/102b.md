...
-  wordType: widget
-  superset: widgets
-  jsonSchema: jsonSchemaFor_widgets
-  concept: conceptFor_widgets
-  itemDirectory: itemDirectoryFor_widgets
-  propertyDirectory: propertyDirectoryFor_widgets

Note that for each of the standard concept word types (jsonSchema, concept, itemDirectory, propertyDirectory), the slug is <wordType>For_<concept>, with the exception of wordType and superset, for which the singular and plural forms are used by themselves without the prefix, respectively. Yeah, that's a mixture of camelCase and snake_case.
