...
Data in DCoSL is represented using graphs, which is a collection of nodes and edges.

Note: Althouth DCoSL is not technically a "graph database", many of the ideas and principles are the same.
