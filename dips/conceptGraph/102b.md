...
-  wordType: widget
-  superset: widgets
-  jsonSchema: jsonSchemaFor_widget
-  concept: conceptFor_widget

Note that for each of the standard concept word types (jsonSchema, concept, etc), the slug is <wordType>For_<concept>, with the exception of superset and wordType, for which the singular and plural forms are used by themselves without the prefix, respectively. Yeah, that's a mixture of camelCase and snake_case.
