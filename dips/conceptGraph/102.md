...
## Unique identifiers inside `wordTypes`
...
where `abcde12345` is the nostr event id (or ipfs hash or ipns name or some other unique identifier) used to identify the word that provides the declaration of the wordType: `animal`.
