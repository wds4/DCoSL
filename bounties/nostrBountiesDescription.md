...
Phase 1 should be relatively straightforward to implement for an experienced nostr developer. For those inexperienced, this project could be a chance to learn some nostr basics while stacking a few sats!
