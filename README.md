...
What is our vision for the decentralized web? We live on a planet with billions of people. If you believe in freedom of association, they should be free to associate and interact as they wish. What does that mean? It means: the spontaneous, dynamic organization of individuals into networks both large and small, with or without overlap, each one of which is capable of highly sophisticated intra-network communication and coordinated action. As cypherpunks we strive to build the tools to serve those needs. Tools that can be customized to the specific, changing, frequently unforseen (by devs) needs of each network. But the hard part: we need to build tools that <i>do not require ever putting any one person, developer, team, or entity in charge of those tools or in charge of the network</i>. Have we succeeded? We're making progress, but we're not there yet.
